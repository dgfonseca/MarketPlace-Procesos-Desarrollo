...
class ProductorPostulanteViewset(viewsets.ModelViewSet):
    queryset = models.ProductorPostulante.objects.all()
    serializer_class = serializers.ProductorPostulanteSerializer
