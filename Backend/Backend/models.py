...
class CantidadProductoCatalogo(models.Model):
    ...
    pedidoUsuario = models.ForeignKey(PedidoUsuario, on_delete=models.CASCADE)
    productoCatalogo = models.ForeignKey(ProductoCatalogo, on_delete=models.CASCADE)
...
class PedidoProductor(models.Model):
    costoTotal = models.FloatField(blank=False, null=False)
    ofertaProductor = models.ForeignKey(OfertaProductor, on_delete=models.CASCADE)
    pedidoUsuario = models.ForeignKey(PedidoUsuario, on_delete=models.DO_NOTHING)
...
class CantidadProducto(models.Model):
    ...
    ofertaProductor = models.ForeignKey(OfertaProductor, on_delete=models.CASCADE)
    pedidoProductor = models.ForeignKey(PedidoProductor, on_delete=models.CASCADE)